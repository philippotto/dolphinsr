(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("uuid-browser"))
    : typeof define === "function" && define.amd
      ? define(["exports", "uuid-browser"], factory)
  ...
  function getCardId(o) {
    return (
      o.master +
      "#" +
      o.combination.front.join(",") +
      "@" +
      o.combination.back.join(",")
    );
  }
  ...
  function computeCardsSchedule(state, now) {
    ...
    Object.keys(state.cardStates).forEach(function(cardId) {
      ...
      s[computeScheduleFromCardState(cardState, now)].push(
        getCardId(cardState)
      );
    });
    return s;
  ...
  function applyToReviewingCardState(prev, ts, rating) {
    ...
    var factorAdj = rating === "hard"
      ? -150
      : rating === "good" ? 0 : rating === "easy" ? 150 : NaN;
    var daysLate = calculateDaysLate(prev, ts);

    var ival = constrainWithin(
      prev.interval + 1,
      MAX_INTERVAL,
      rating === "hard"
  ...
  var DolphinSR = (function() {
    ...
    function DolphinSR() {
      var currentDateGetter = arguments.length > 0 && arguments[0] !== undefined
        ? arguments[0]
        : function() {
            return new Date();
          };
    ...
    createClass(DolphinSR, [
      {
        ...
        value: function _addMaster(master) {
          ...
          master.combinations.forEach(function(combination) {
            ...
            _this._state.cardStates[id] = makeInitialCardState(
              master.id,
              combination
            );
          });
      ...
      },
      {
        ...
        value: function addMasters() {
          ...
          for (
            var _len = arguments.length, masters = Array(_len), _key = 0;
            _key < _len;
            _key++
          ) {
      ...
      },
      {
        ...
        value: function addReviews() {
          ...
          for (
            var _len2 = arguments.length, reviews = Array(_len2), _key2 = 0;
            _key2 < _len2;
            _key2++
          ) {
      ...
      },
      {
        ...
        value: function _rebuild() {
          ...
          this.addMasters.apply(
            this,
            toConsumableArray(
              Object.keys(masters).map(function(k) {
                return masters[k];
              })
            )
          );
